...
public class RabbitmqConfig {
    ...
    public static String ACCOUNT_QUEUE = "account_queue";
    public static String EXCHANGE = "exchange";
    public static String TRANSACTION_ROUTING = "transactionRouting";
    public static String ACCOUNT_ROUTING = "accountRouting";
